...
class CombinatorialDerivation:
    ...
    def run_sbol_2(self,triplepack,env):
        ...
        template = triplepack.search((self.cd_name,identifiers.predicates.template,None))[0]
            ...
            for variant in variants:
                ...
                for s,p,o in template:
                    ...
                    # A Sequence Constraint.
                        ...
                        subject = triplepack.search((o,identifiers.predicates.sequence_constraint_subject,None))
                        object = triplepack.search((o,identifiers.predicates.sequence_constraint_object,None))
...
def generate_component(parent,component_name):
    ...
    type = (Uri(component_name), rdf_type, identifiers.objects.component)
...
def generate_constraint(constraint_triples,constraint_name,subject_name,object_name):
    ...
    for s,p,o in constraint_triples:
        ...
        if p == identifiers.predicates.sequence_constraint_subject:
            o = subject_name
        elif p == identifiers.predicates.sequence_constraint_object:
            o = object_name
